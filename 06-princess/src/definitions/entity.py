...
ENTITY_DEFS: Dict[str, Dict[str, Any]] = {
    ...
    "vampire": {
        "walk_speed": 30,
        "animations": {
            "walk-left": {"frames": [13, 14, 15, 16, 17, 18], "interval": 0.2, "texture": "vampire-walk"},
            "walk-right": {"frames": [19, 20, 21, 22, 23, 24], "interval": 0.2, "texture": "vampire-walk"},
            "walk-down": {"frames": [1, 2, 3, 4, 5, 6], "interval": 0.2, "texture": "vampire-walk"},
            "walk-up": {"frames": [7, 8, 9, 10, 11, 12], "interval": 0.2, "texture": "vampire-walk"},
            "idle-left": {"frames": [9, 10, 11, 12], "interval": 0.2, "texture": "vampire-idle"},
            "idle-right": {"frames": [13, 14, 15, 16], "interval": 0.2, "texture": "vampire-idle"},
            "idle-down": {"frames": [1, 2, 3, 4], "interval": 0.2, "texture": "vampire-idle"},
            "idle-up": {"frames": [5, 6, 7, 8], "interval": 0.2, "texture": "vampire-idle"},
            "attack-left": {"frames": [25, 26, 27, 28, 29, 30, 31], "interval": 0.2, "texture": "vampire-attack"},
            "attack-right": {"frames": [37, 38, 39, 40, 41, 42, 43], "interval": 0.2, "texture": "vampire-attack"},
            "attack-down": {"frames": [1, 2, 3, 4, 5, 6, 7], "interval": 0.2, "texture": "vampire-attack"},
            "attack-up": {"frames": [13, 14, 15, 16, 17, 18, 19], "interval": 0.2, "texture": "vampire-attack"},
            "hurt-left": {"frames": [24, 25, 26], "interval": 0.2, "texture": "vampire-hurt"},
            "hurt-right": {"frames": [35, 36, 37], "interval": 0.2, "texture": "vampire-hurt"},
            "hurt-down": {"frames": [2, 3, 4], "interval": 0.2, "texture": "vampire-hurt"},
            "hurt-up": {"frames": [13, 14, 15], "interval": 0.2, "texture": "vampire-hurt"},
            "death-left": {"frames": [27, 28, 29, 30, 31, 32, 33], "interval": 0.2, "loops": 1, "texture": "vampire-hurt"},
            "death-right": {"frames": [38, 39, 40, 41, 42, 43, 44], "interval": 0.2, "loops": 1, "texture": "vampire-hurt"},
            "death-down": {"frames": [5, 6, 7, 8, 9, 10, 11], "interval": 0.2, "loops": 1, "texture": "vampire-hurt"},
            "death-up": {"frames": [16, 17, 18, 19, 20, 21, 22], "interval": 0.2, "loops": 1, "texture": "vampire-hurt"},
        },
    },
}
